...
class SampleDataListView extends StatelessWidget {
  final SampleDataController sampleDataController =Get.put(SampleDataController());
                  ...
                  children: [
                    Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.network(
                          sampleDataController.sampleDataList[index].thumbnailUrl,
                          width: 150,
                          height: 100,
                          fit: BoxFit.fill,
                    ...
                    Flexible(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                          Text(sampleDataController.sampleDataList[index].title,
